...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_ESCAPE, KC_NO,   KC_LGUI, LCTL_T(KC_TAB), LT(2, KC_SPACE), MO(1), LSFT_T(KC_BACKSPACE), KC_LALT, KC_NO,   KC_ENTER),
    [1] = LAYOUT(
    ...
    [3] = LAYOUT(
        KC_NO, QK_REBOOT, QK_BOOT, KC_NO, KC_NO, CYC_IMG, CYC_IMG_REV, KC_NO, KC_NO, KC_DELETE,
