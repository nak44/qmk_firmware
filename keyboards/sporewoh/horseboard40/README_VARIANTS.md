# Horseboard40 Firmware Variants
...
- **Build Command**: `make sporewoh/horseboard40/rev1/oled:default`
...
- **Build Command**: `make sporewoh/horseboard40/rev1/lcd:default`
...
```
keyboards/sporewoh/horseboard40/
├── rev1/
│   ├── oled/              # OLED variant
...
### Build OLED variant:
```bash
make sporewoh/horseboard40/rev1/oled:default
```
...
2. **Keep common code** in the base `horseboard40.c` file
